<%-- 
    Document   : newjsp
    Created on : Mar 3, 2024, 12:01:28 AM
    Author     : AD
--%>
                                ...
                                <div class="panel-body">
                                    <form action="UpdatePost" method="post" enctype="multipart/form-data">
                                        <div class="form-group">
                                            <label>Status:</label>
                                            <label>
                                                <input type="radio" name="status" ${requestScope.status eq 1 ? 'checked' : ''} value="1" />Show
                                            </label>
                                            <label>
                                                <input type="radio" name="status" ${requestScope.status eq 0 ? 'checked' : ''} value="0" />Hide
                                            </label>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="shortContent" value="${shortContent}">
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <img src="../${image}" alt="Current Image" style="max-width: 300px; max-height: 300px;">
                                        </div>
                                        <input type="hidden" name="blogId" value="${blogId}"> <!-- Add a hidden field for blogId -->
                                        <c:if test="${update eq 'update'}">
                                            <button type="submit" class="btn btn-primary">Update Post</button>
                                        </c:if>
                                    </form>
                                    <hr><!-- comment -->
                                    <a href="PostManager" class="btn btn-danger">Back to Post List</a>
