<%-- 
    Document   : newjsp
    Created on : Mar 3, 2024, 12:10:09 AM
    Author     : AD
--%>
                        ...
                        <div class="col-md-12">
                            <section class="panel">
                                ...
                                <header class="panel-heading">
                                    <h2>Add Post</h2>
                                    <form action="../../Manager/AddPost" method="post" enctype="multipart/form-data">
                                    ...
                                    <hr><!-- comment -->
                                    <a href="../../Manager/PostManager" class="btn btn-danger">Back to Post List</a>
