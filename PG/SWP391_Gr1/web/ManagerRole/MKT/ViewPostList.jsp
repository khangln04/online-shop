<%-- 
    Document   : newjsp
    Created on : Mar 2, 2024, 11:47:21 PM
    Author     : AD
--%>
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="panel">
                                ...
                                <hr>
                                <a href="../ManagerRole/MKT/AddPost.jsp" class="btn btn-success">
                                    Create Post
                                </a>
                                <table class="table">
                                    <thead>
                                        <tr>
                                            <th class="sortable" onclick="sortTable(0)">Post ID</th>
                                            <th class="sortable" onclick="sortTable(1)">Title</th>
                                            <th class="sortable" onclick="sortTable(2)">Short Content</th>
                                            <th class="sortable" onclick="sortTable(3)">Author</th>
                                            <th class="sortable" onclick="sortTable(4)">Published Date</th>
                                    ...
                                    <c:forEach var="i" items="${list}">
                                        <tr>
                                            <td>${i.getId()}</td>
                                            <td>${i.getTitle()}</td>
                                            <td>${i.getShortContent()}</td>
                                            <td>${uDAO.getUserById(i.getUserId()).getFullName()}</td>
                                            <td>${i.getPublishedDate()}</td>
                                        <c:if test="${i.isActive eq 1}">
                                            <td style="text-align: center;color: green">Show
                                            </td>
                                        </c:if>
                                        <c:if test="${i.isActive eq 0}">
                                            <td style="text-align: center;color: red">Hide
                                            </td>
                                        </c:if>
                                        <td>
                                            <a href="UpdatePost?id=${i.getId()}">Update Post</a>
                                        </td>
