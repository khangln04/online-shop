                                    ...
                                    <table class="table table-hover">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="sortable" onclick="sortTable(4)">Address</th>
                                                <th class="sortable" onclick="sortTable(5)">City</th>
                                                <th class="sortable" onclick="sortTable(6)">Country</th>
                                                <th>Actions</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            ...
                                            <c:forEach var="i" items="${listCustomer}">
                                                <tr>
                                                    ...
                                                    <td>${i.getCountry()}</td>
                                                    <td>
                                                        <button type="button" class="btn-group btn-group">
                                                            <a href="CustomerDetail?id=${i.getId()}" style="color: black">View/Edit</a>
                                                        </button>
                                                    </td>
                                                </tr>
                                            </c:forEach>
