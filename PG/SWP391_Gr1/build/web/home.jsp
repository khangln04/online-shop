                            ...
                            <div class="carousel-inner" >
                                <c:forEach items="${requestScope.slider}" var="s">
                                    <div class="item <c:if test="${s.sid==1}">active</c:if>" >
                                        <div class="col-sm-11" style="background-image: url('${s.image}'); background-size: cover; background-repeat: repeat; ">
                                            <div style="margin-bottom: 80px; padding: 0 30px; " >
                                                <h1><span>GearHead </span>Auto </h1>
                                                <h2 style="color: #fff">${s.title}</h2>
                                                <p style="color: #fff">${s.content}</p>
                                    ...
                                    <div class="product-image-wrapper">
                                        <div class="single-products">
                                            <div class="productinfo text-center">
                                                <img src="${p.images.url}" alt="" style=" height: 160px"/>
                                                <h2>$${p.price}</h2>
                                                <p>${p.productName}</p>
